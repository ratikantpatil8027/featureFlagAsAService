...
public class FlagResponse {
    ...
    public FlagResponse(UUID featureFlagId, String client, String name, String attributes,
    ...
    public static class Builder {
        ...
        public FlagResponse build() {
            return new FlagResponse(featureFlagId, client, name, attributes, formulaString, rollout, enabled);
        }
    }
